...
* 精通：html, css, js, vue
* 熟练：nodejs, jquery, ts, react, webpack
* 了解：java，mysql

## 近两年参与项目

* 智慧城市时空信息（通用）云平台、智慧大厂时空信息云平台、智慧宝安时空信息云平台、智慧聊城时空信息云平台
* 主要工作内容：1、前端框架搭建；2、需求整理，简单原型设计；3、页面编写；4、与后台对接数据
* 主要使用技术栈：vue全家桶、webpack、echarts、jQuery、ElementUI、git、svn、js、css、html
 ...
 * 完毕.
 *
 * This page is inspired by http://strml.net/.
 *
 */`;
